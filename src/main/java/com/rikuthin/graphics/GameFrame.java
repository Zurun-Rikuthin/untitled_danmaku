...
import java.awt.Color;			// need this for GUI objects
import java.awt.Container;			// need this for Layout Managers
import java.awt.Dimension;		// need this to respond to GUI events
...
public class GameFrame extends JFrame
    ...
    // declare labels 
    private final JLabel statusBarL;
    private final JLabel keyL;
    private final JLabel mouseL;
    ...
    private final JButton endB;
    private final JButton startNewB;
